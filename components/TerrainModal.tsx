        ...
        >
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              {/* NEW: Blockchain Reservation Button */}
              {isConnected && isOnFuji ? (
                <button 
                  onClick={onSmartContractClick}
                  className="w-full bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-4 px-6 rounded-xl font-medium hover:from-purple-700 hover:to-indigo-800 transition-colors flex items-center justify-center gap-3"
                >
                  <Wallet className="w-5 h-5" />
                  {getTerrainTranslation('terrainModal.reserveSmartContract')}
                </button>
              ) : !isConnected ? (
                <button 
                ...
                >
                  <Wallet className="w-5 h-5" />
                  {getTerrainTranslation('terrainModal.connectWalletFirst')}
                </button>
              ) : (
                <button 
                  onClick={() => {}}
                  className="w-full bg-gradient-to-r from-yellow-600 to-orange-600 text-white py-4 px-6 rounded-xl font-medium hover:from-yellow-700 hover:to-orange-700 transition-colors flex items-center justify-center gap-3"
                >
                  <Wallet className="w-5 h-5" />
                  {getTerrainTranslation('terrainModal.switchToFuji')}
                </button>
              )}
