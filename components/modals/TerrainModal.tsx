...
//   // ✅ FUNCIÓN PARA CALCULAR DEPÓSITO 10%
//   const calculateDeposit = (price: string) => {
//     // Si el precio dice "Consultar" o no tiene números
...
//     // Si no se pudo extraer un número válido
...
//                   {getTerrainTranslation('terrainModal.deposit')}
//                 </div>
//                 <div className="text-blue-400 font-semibold text-lg">
//                   {calculateDeposit(selectedTerrain.price)}
//                 </div>
//               </div>
//             </div>
